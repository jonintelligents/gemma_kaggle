...
def main():
    ...
    print("Welcome to the LLM Demo with Ollama and CRUD Tooling!")
    ...
    while True:
        ...
        if llm_response["type"] == "tool_code":
            ...
            try:
                ...
                final_llm_response = call_ollama_llm(tool_output_message, chat_history)
